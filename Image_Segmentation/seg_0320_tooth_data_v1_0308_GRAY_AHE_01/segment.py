...
# 處理整個資料夾中的圖像
folder_path = "E:\\Lab\share\\YOLO_segmentation\\seg_0325_tooth_data_v1_0308_GRAY_AHE_01\\191_images"
for filename in os.listdir(folder_path):
    if filename.endswith(".jpg"):
        ...
        for i, idx in enumerate(sorted_indices):
            ...
            # 保存提取的图像部分
            output_folder = 'E:\\Lab\\share\\YOLO_segmentation\\seg_0325_tooth_data_v1_0308_GRAY_AHE_01\\191_cropped_images'
            if not os.path.exists(output_folder):
                os.makedirs(output_folder)
            cropped_image.save(os.path.join(output_folder, f'{original_filename}_{i+1}.jpg'))

        # 保存预测结果
        output_folder = 'E:\\Lab\\share\\YOLO_segmentation\\seg_0325_tooth_data_v1_0308_GRAY_AHE_01\\191_images_predicts'
        if not os.path.exists(output_folder):
            os.makedirs(output_folder)
        for r in results:

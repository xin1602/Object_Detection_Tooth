...
# 讀取圖片
image_path = 'F:\\Lab\\share\\dataset\\two_label_data_v1\\GRAY_AHE\\12.jpg'
...
# 建立 mask_images 資料夾
import os
if not os.path.exists('F:\\Lab\\share\\YOLO_segmentation\\seg_0311\\mask_images'):
    os.makedirs('F:\\Lab\\share\\YOLO_segmentation\\seg_0311\\mask_images')
...
for i in range(len(obb_info.xyxyxyxy)):
    ...
    # 保存遮罩圖像
    cv2.imwrite(f'mask_images/mask_{i}.jpg', masked_image)

...
folder_path = "E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\origin\\normal"
for filename in os.listdir(folder_path):
    if filename.endswith(".jpg"):
        ...
        if os.path.exists(rotated_image_path) and os.path.exists(bbox_info_path):
            ...
            output_folder_cropped = 'E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\cropped_images_x20_y40\\normal'
...
folder_path = "E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\origin\\apical lesion"
for filename in os.listdir(folder_path):
    if filename.endswith(".jpg"):
        ...
        if os.path.exists(rotated_image_path) and os.path.exists(bbox_info_path):
            ...
            output_folder_cropped = 'E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\cropped_images_x20_y40\\apical lesion'
            if not os.path.exists(output_folder_cropped):
                os.makedirs(output_folder_cropped)
...
folder_path = "E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\origin\\peri endo"
for filename in os.listdir(folder_path):
    if filename.endswith(".jpg"):
        ...
        if os.path.exists(rotated_image_path) and os.path.exists(bbox_info_path):
            ...
            output_folder_cropped = 'E:\\Lab\\share\\dataset\\two_label_data_forCNN_v16\\cropped_images_x20_y40\\peri endo'
            if not os.path.exists(output_folder_cropped):
                os.makedirs(output_folder_cropped)

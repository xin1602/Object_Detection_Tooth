...
% 設定原始圖片資料夾
original_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\origin\normal";
%original_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\origin\apical lesion";
%original_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\origin\peri endo";


% 設定增強後圖片保存資料夾
enhanced_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\final\normal";
%enhanced_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\final\apical lesion";
%enhanced_folder = "E:\Lab\share\dataset\two_label_data_forCNN_v14\final\peri endo";
...
for i = 1:length(image_files)
    ...
    % 資料增強：逆時針旋轉90度 再水平翻轉
    rotated_90_horizontal = flip(rotated_90, 2);
    %imwrite(rotated_90_horizontal, fullfile(enhanced_folder, strcat(image_files(i).name, '_rotated_90_horizontal.jpg')));

    % 資料增強：逆時針旋轉270度 再水平翻轉
    rotated_270_horizontal = flip(rotated_270, 2);
    %imwrite(rotated_270_horizontal, fullfile(enhanced_folder, strcat(image_files(i).name, '_rotated_270_horizontal.jpg')));

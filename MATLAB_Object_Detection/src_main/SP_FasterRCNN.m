...
[bboxes,scores] = detect(FasterRCNNdetector,I,'Threshold',0.7);
...
detectionResults = detect(FasterRCNNdetector, preprocessedTestData, 'Threshold', 0.7);

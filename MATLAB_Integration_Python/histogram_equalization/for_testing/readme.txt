histogram_equalization MATLAB Python Package
...
2. Installing the histogram_equalization Package

A. Change to the directory that contains the file setup.py and the subdirectory 
histogram_equalization. If you do not have write permissions, copy all its contents to a 
...
3. Using the histogram_equalization Package

The histogram_equalization package is on your Python path. To import it into a Python 

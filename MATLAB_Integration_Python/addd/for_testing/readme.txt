...
2. Installing the addd Package

A. Change to the directory that contains the file setup.py and the subdirectory addd. If 
...
3. Using the addd Package

The addd package is on your Python path. To import it into a Python script or session, 
execute:
